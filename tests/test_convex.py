...
class TestPoint:
    ...
    def setup_method(self):
        ...
        Figure.p2 = R2Point(3, 0)
        Figure.p3 = R2Point(2, -2)
    ...
    def test_convex_dist1(self):
        assert self.f.convex_dist() == 0

    def test_convex_dist2(self):
        f = Point(R2Point(0, 1))
        assert f.convex_dist() == 1

    def test_convex_dist3(self):
        f = Point(R2Point(2, -1))
        assert f.convex_dist() == 0

    def test_convex_dist4(self):
        f = Point(R2Point(-1, 0))
        assert f.convex_dist() == 1

    def test_convex_dist5(self):
        f = Point(R2Point(1, -1))
        assert f.convex_dist() == 0
...
class TestSegment:
    ...
    def setup_method(self):
        ...
        Figure.p1 = R2Point(0, 0)
        Figure.p2 = R2Point(4, 0)
        Figure.p3 = R2Point(4, 4)
    ...
    def test_convex_dist2(self):
        f = Segment(R2Point(0, 1), R2Point(0, 0))
        assert f.convex_dist() == 0

    def test_convex_dist3(self):
        f = Segment(R2Point(0, 0), R2Point(1, 1))
        assert f.convex_dist() == 0

    def test_convex_dist4(self):
        f = Segment(R2Point(3, 5), R2Point(3, -1))
        assert f.convex_dist() == 0

    def test_convex_dist5(self):
        f = Segment(R2Point(-2, 1), R2Point(-2, -1))
        assert f.convex_dist() == 2
...
class TestPolygon:
    ...
    def test_convex_dist2(self):
        f = Polygon(
                    ...
                    R2Point(5, 6),
                    R2Point(5, -1))
        assert round(f.convex_dist(), 2) == 0.71
    ...
    def test_convex_dist6(self):
        self.f.add(R2Point(-1, -1)).add(R2Point(-1, 6))
        self.f.add(R2Point(6, -1)).add(R2Point(6, 6))
        assert self.f.convex_dist() == 1
